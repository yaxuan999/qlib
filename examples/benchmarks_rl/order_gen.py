...
def w_order(f, start, end):
    ...
    order_train = order[order.index.get_level_values(0) < pd.Timestamp('2020-12-01')]
    order_test = order[order.index.get_level_values(0) >= pd.Timestamp('2020-12-01')]
    order_valid = order_test[order_test.index.get_level_values(0) < pd.Timestamp('2021-01-01')]
    order_test = order_test[order_test.index.get_level_values(0) >= pd.Timestamp('2021-01-01')]
